...
public class SmartConnection implements Connection {
	...
	public SmartConnection(Connection connection, ConnectionContext context) {
	...
	public Statement createStatement() throws SQLException {
		...
		return new SmartStatement(this, statement, context.getMeterRegistry());
	}

	@Override
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		PreparedStatement statement = connection.prepareStatement(sql);
		return new SmartPreparedStatement(this, statement, context.getMeterRegistry(), sql);
	}

	@Override
	public CallableStatement prepareCall(String sql) throws SQLException {
		CallableStatement statement = connection.prepareCall(sql);
		return new SmartCallableStatement(this, statement, context.getMeterRegistry(), sql);
	}
	...
	public void evaluateRules(SmartStatement statement) {
