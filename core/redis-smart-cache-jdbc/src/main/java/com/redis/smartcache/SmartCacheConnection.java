...
public class SmartCacheConnection implements Connection {
	...
	public SmartCacheConnection(Connection connection) {
		this(connection, new ConnectionContext());
	}

	public SmartCacheConnection(Connection connection, ConnectionContext context) {
	...
	public Statement createStatement() throws SQLException {
		...
		return new SmartCacheStatement(this, statement, context.getMeterRegistry());
	}

	@Override
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		PreparedStatement statement = connection.prepareStatement(sql);
		return new SmartCachePreparedStatement(this, statement, context.getMeterRegistry(), sql);
	}

	@Override
	public CallableStatement prepareCall(String sql) throws SQLException {
		CallableStatement statement = connection.prepareCall(sql);
		return new SmartCacheCallableStatement(this, statement, context.getMeterRegistry(), sql);
	}
	...
	public void evaluateRules(SmartCacheStatement statement) {
