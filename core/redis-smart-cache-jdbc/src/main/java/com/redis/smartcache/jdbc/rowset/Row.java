...
public class Row extends BaseRow implements Serializable {
	...
	/**
	 * A <code>BitSet</code> object containing a flag for each column in this
	 * <code>Row</code> object, with each flag indicating whether or not the value
	 * in the column has been changed.
	 * 
	 * @serial
	 */
	...
	/**
	 * A <code>boolean</code> indicating whether or not this <code>Row</code> object
	 * has been deleted. <code>true</code> indicates that it has been deleted;
	 * <code>false</code> indicates that it has not.
	 * 
	 * @serial
	 */
	...
	/**
	 * A <code>boolean</code> indicating whether or not this <code>Row</code> object
	 * has been updated. <code>true</code> indicates that it has been updated;
	 * <code>false</code> indicates that it has not.
	 * 
	 * @serial
	 */
	...
	/**
	 * A <code>boolean</code> indicating whether or not this <code>Row</code> object
	 * has been inserted. <code>true</code> indicates that it has been inserted;
	 * <code>false</code> indicates that it has not.
	 * 
	 * @serial
	 */
	...
	/**
	 * Creates a new <code>Row</code> object with the given number of columns. The
	 * newly-created row includes an array of original values, an array for storing
	 * its current values, and a <code>BitSet</code> object for keeping track of
	 * which column values have been changed.
	 */
	...
	/**
	 * Creates a new <code>Row</code> object with the given number of columns and
	 * with its array of original values initialized to the given array. The new
	 * <code>Row</code> object also has an array for storing its current values and
	 * a <code>BitSet</code> object for keeping track of which column values have
	 * been changed.
	 */
	 ...
	 * methods.
	 *
	 * @param idx the number of the column in this <code>Row</code> object that is
	 *            to be set; the index of the first column is <code>1</code>
	 ...
	 *
	 * @param columnIndex the index of the column value to be retrieved; the index
	 *                    of the first column is <code>1</code>
	...
	/**
	 * Indicates whether the designated column of this <code>Row</code> object has
	 * been changed.
	 * 
	 * @param idx the index into the <code>BitSet</code> object maintained by this
	 *            <code>Row</code> object to keep track of which column values have
	 *            been modified; the index of the first bit is <code>0</code>
	...
	/**
	 * Sets this <code>Row</code> object's <code>deleted</code> field to
	 * <code>true</code>.
	 *
	 * @see #getDeleted
	 */
	...
	/**
	 * Retrieves the value of this <code>Row</code> object's <code>deleted</code>
	 * field, which will be <code>true</code> if one or more of its columns has been
	 * deleted.
	 * 
	 * @return <code>true</code> if a column value has been deleted;
	 *         <code>false</code> otherwise
	 *
	 * @see #setDeleted
	 */
	...
	/**
	 * Retrieves the value of this <code>Row</code> object's <code>inserted</code>
	 * field, which will be <code>true</code> if this row has been inserted.
	 * 
	...
	/**
	 * Retrieves the value of this <code>Row</code> object's <code>updated</code>
	 * field.
	 * 
	 * @return <code>true</code> if this <code>Row</code> object has been updated;
	 ...
	 *
	 * @param idx the index into the <code>BitSet</code> object maintained by this
	 *            <code>Row</code> object; the first bit is at index <code>0</code>
	 *
	 */
	...
	/**
	 * Sets the column values in this <code>Row</code> object's internal array of
	 * original values with the values in its internal array of current values, sets
	 * all the values in this <code>Row</code> object's internal array of current
	 * values to <code>null</code>, clears all the bits in this <code>Row</code>
	 * object's internal bitset, and sets its <code>updated</code> field to
	 * <code>false</code>.
	 * <P>
	 * This method is called internally by the <code>CachedRowSet</code> method
	 * <code>makeRowOriginal</code>.
	 */
