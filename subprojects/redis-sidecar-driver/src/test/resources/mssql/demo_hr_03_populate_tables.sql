...
-------------------------
INSERT INTO Demo_HR..REGIONS (REGION_ID, REGION_NAME) 
VALUES
  (1,'Europe'),
  (2,'Americas'),
  (3,'Asia'),
...
---------------------------
INSERT INTO Demo_HR..COUNTRIES (COUNTRY_ID,COUNTRY_NAME,REGION_ID,DATE_LAST_UPDATED) 
VALUES
...
---------------------------
INSERT INTO Demo_HR..LOCATIONS (LOCATION_ID,STREET_ADDRESS,POSTAL_CODE,CITY,STATE_PROVINCE,COUNTRY_ID) 
VALUES
...
-- Populate Table JOBS
----------------------
INSERT INTO Demo_HR..JOBS (JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY) 
VALUES
...
-------------------------------
INSERT INTO Demo_HR..JOBS_SNAPSHOT (JOB_ID,JOB_TITLE,MIN_SALARY,MAX_SALARY) 
VALUES
  ('AD_PRES','President',20080,40000),
  ('AD_VP','Administration Vice President',15000,30000),
  ('AD_ASST','Administration Assistant',3000,6000),
...
------------------------------
INSERT INTO Demo_HR..DEPARTMENTS (DEPARTMENT_ID,DEPARTMENT_NAME,MANAGER_ID,LOCATION_ID,URL) 
VALUES
...
-----------------------------
INSERT INTO Demo_HR..JOB_HISTORY (EMPLOYEE_ID,START_DATE,END_DATE,JOB_ID,DEPARTMENT_ID) 
VALUES
...
---------------------------
INSERT INTO Demo_HR..EMPLOYEES (EMPLOYEE_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID,SOME_DATE_FMT1,SOME_DATE_FMT2,SOME_DATE_FMT3,SOME_DATE_FMT4,FAKE_SSN,ZIP5,ZIP5OR9,ZIP9,EMAIL_ADDRESS) 
VALUES
