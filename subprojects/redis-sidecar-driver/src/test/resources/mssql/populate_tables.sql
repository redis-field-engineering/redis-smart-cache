...
-- DDL Cleanup
ALTER TABLE "JOB_HISTORY" ADD CONSTRAINT "JHIST_EMP_FK" FOREIGN KEY ("EMPLOYEE_ID") REFERENCES "DEMO_HR".."EMPLOYEES" ("EMPLOYEE_ID"); 

ALTER TABLE "DEPARTMENTS" ADD CONSTRAINT "DEPT_MGR_FK" FOREIGN KEY ("MANAGER_ID")  REFERENCES "DEMO_HR".."EMPLOYEES" ("EMPLOYEE_ID");
