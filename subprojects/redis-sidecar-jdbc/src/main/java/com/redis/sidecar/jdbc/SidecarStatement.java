...
public class SidecarStatement implements Statement {
	...
	protected final Timer databaseTimer;
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		...
		if (this.resultSet == null) {
			...
			try {
				databaseResultSet = databaseTimer.recordCallable(() -> statement.executeQuery(sql));
	...
	public boolean execute(String sql) throws SQLException {
		...
		if (resultSet == null) {
			try {
				return databaseTimer.recordCallable(() -> statement.execute(sql));
			} catch (SQLException e) {
				throw e;
			} catch (Exception e) {
				throw new SQLException(e);
	...
	public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
		...
		if (resultSet == null) {
			try {
				return databaseTimer.recordCallable(() -> statement.execute(sql, autoGeneratedKeys));
			} catch (SQLException e) {
				throw e;
			} catch (Exception e) {
				throw new SQLException(e);
	...
	public boolean execute(String sql, int[] columnIndexes) throws SQLException {
		...
		if (resultSet == null) {
			try {
				return databaseTimer.recordCallable(() -> statement.execute(sql, columnIndexes));
			} catch (SQLException e) {
				throw e;
			} catch (Exception e) {
				throw new SQLException(e);
	...
	public boolean execute(String sql, String[] columnNames) throws SQLException {
		...
		if (resultSet == null) {
			try {
				return databaseTimer.recordCallable(() -> statement.execute(sql, columnNames));
			} catch (SQLException e) {
				throw e;
			} catch (Exception e) {
				throw new SQLException(e);
