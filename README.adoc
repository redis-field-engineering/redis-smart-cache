...
image::{grafana-dir}/redis-datasource.png[Redis Datasource]

Now import the demo dashboard by clicking on Dashboards/Import in the sidebar.

image::{grafana-dir}/import-dashboard.png[Import Dashboard]
...
image::{grafana-dir}/redis-datasource.png[Dashboard]
