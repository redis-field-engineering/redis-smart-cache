...
image:smart-cache-grafana-dashboard-no-caching.png[Dashboard without caching,width=1486]
...
image:smart-cache-grafana-dashboard-with-caching.png[Dashboard with Caching,width=1486]
