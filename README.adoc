...
:img: https://github.com/redis-field-engineering/redis-smart-cache/raw/master/.github/images

++++
<p align="center">
  <img alt="Redis Smart Cache" src="https://github.com/redis-field-engineering/redis-smart-cache/raw/master/.github/images/redis-smart-cache-banner.png">
